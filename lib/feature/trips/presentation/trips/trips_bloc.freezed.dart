...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TripsEvent);
}
...
/// @nodoc
class $TripsEventCopyWith<$Res>  {
$TripsEventCopyWith(TripsEvent _, $Res Function(TripsEvent) __);
}


/// Adds pattern-matching-related methods to [TripsEvent].
extension TripsEventPatterns on TripsEvent {
...
class _Watch implements TripsEvent {
  const _Watch();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TripsState);
}
...
/// @nodoc
class $TripsStateCopyWith<$Res>  {
$TripsStateCopyWith(TripsState _, $Res Function(TripsState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String message)?  error,TResult Function( List<TripEntity> trips)?  loaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.message);case _Loaded() when loaded != null:
return loaded(_that.trips);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String message)  error,required TResult Function( List<TripEntity> trips)  loaded,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String message)?  error,TResult? Function( List<TripEntity> trips)?  loaded,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Error() when error != null:
...
class _Initial implements TripsState {
  const _Initial();
...
class _Loading implements TripsState {
  const _Loading();
...
class _Error implements TripsState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $TripsStateCopyWith<$Res> {
...
class _Loaded implements TripsState {
  const _Loaded({required  List<TripEntity> trips}): _trips = trips;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._trips, _trips));
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $TripsStateCopyWith<$Res> {
